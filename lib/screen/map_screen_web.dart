...
class _MapScreenWebState extends MapScreenBaseState<MapScreenWeb> {
      ...
      setState(() {
        ...
        circles.add(
          Circle(
            ...
            radius: searchRadius,
            fillColor: Colors.blue.withOpacity(0.15), // 웹에서 더 눈에 띄게
            ...
            onTap: () {
              ...
              // 현재 위치에 마커 추가 다이얼로그 표시
              showAddMarkerDialog(currentPosition);
            },
          ),
        );
      });
  ...
  void onMapTapped(LatLng position) {
    ...
    double distance = LocationService.calculateDistance(currentPosition, position);
                ...
                if (selectedMarkerInfo!.youtubeLink != null &&
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        // 올바른 클래스 이름으로 수정
                        final String? videoId = YoutubeService.extractYoutubeVideoId(
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async {
                  ...
                  // Firestore에서도 삭제
                  try {
                    await markerService.deleteMarkerFromFirestore(markerIdToDelete!);
